...
public sealed class CometBftWebSocketClientTests
{
    ...
    public async Task NewBlockReceived_EventCanBeSubscribed()
    {
        ...
        var handler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.Block>>>();
    ...
    public async Task TxExecuted_EventCanBeSubscribed()
    {
        ...
        var handler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.TxResult>>>();
    ...
    public async Task NewBlockHeaderReceived_EventCanBeSubscribed()
    {
        ...
        var handler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.BlockHeader>>>();
    ...
    public async Task VoteReceived_EventCanBeSubscribed()
    {
        ...
        var handler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.Vote>>>();
    ...
    public async Task ValidatorSetUpdated_EventCanBeSubscribed()
    {
        ...
        var handler = Substitute.For<EventHandler<TendermintEventArgs<IReadOnlyList<Core.Domain.Validator>>>>();
    ...
    public async Task AllEvents_CanBeSubscribedAndUnsubscribed_WithoutThrow()
    {
        ...
        var blockHandler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.Block>>>();
        var headerHandler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.BlockHeader>>>();
        var txHandler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.TxResult>>>();
        var voteHandler = Substitute.For<EventHandler<TendermintEventArgs<Core.Domain.Vote>>>();
        var validatorHandler = Substitute.For<EventHandler<TendermintEventArgs<IReadOnlyList<Core.Domain.Validator>>>>();
